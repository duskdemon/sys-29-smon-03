# Домашнее задание к занятию "`Система мониторинга Zabbix. Часть 2`" - `Дунаев Дмитрий`
...
![Custom dashboard](https://github.com/duskdemon/sys-29-smon-03/blob/main/img/hw-03-zabb-dash.png)
